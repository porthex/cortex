...
1. Define Cortex request/result models and a backend protocol independent of Hindsight.
...
6. Add thin `cortex-mcp-http` and `cortex-mcp-stdio` entry points; stdio writes protocol data only to stdout.
