...
`cortex-mcp-stdio-hermes` executable is the explicit compatibility facade for
...
changing Cortex's public memory contract.
...
- Continue transparent proxying: leaks Hindsight contracts and cannot enforce Cortex bank semantics.
